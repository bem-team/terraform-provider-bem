...
page_title: "bem_function Data Source - Bem"
subcategory: ""
description: |-
  
---

# bem_function (Data Source)
...
- `include_extra_settings` (Boolean) Populate the function's `extraConfig` block. Omitted or `false` by
