			...
			"function": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"origin": schema.SingleNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectType[FunctionFunctionClassificationsOriginDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"email": schema.SingleNestedAttribute{
											Computed:   true,
											CustomType: customfield.NewNestedObjectType[FunctionFunctionClassificationsOriginEmailDataSourceModel](ctx),
											Attributes: map[string]schema.Attribute{
								...
								"regex": schema.SingleNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectType[FunctionFunctionClassificationsRegexDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"patterns": schema.ListAttribute{
											Computed:    true,
											CustomType:  customfield.NewListType[types.String](ctx),
					...
					"render_config": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[FunctionFunctionRenderConfigDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"template": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[FunctionFunctionRenderConfigTemplateDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									...
									"placeholders": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[FunctionFunctionRenderConfigTemplatePlaceholdersDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
