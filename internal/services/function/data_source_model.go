...
type FunctionFunctionConfigDataSourceModel struct {
	...
	Endpoints customfield.NestedObjectList[FunctionFunctionConfigEndpointsDataSourceModel] `tfsdk:"endpoints" json:"endpoints,computed"`
}
...
type FunctionFunctionConfigEndpointsDataSourceModel struct {
